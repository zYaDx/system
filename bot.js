   ...
   client.on("message", message => {
    if (message.content === "*help--1") {
     const embed = new Discord.RichEmbed() 
         ...
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/w4Nuj8J :scroll: **`)
   ...
   message.author.sendEmbed(embed)
    ...
    if (message.content === "*help-g") {
     const embed = new Discord.RichEmbed() 
         .setThumbnail(message.author.avatarURL)
         .setColor("#00FF00")
         .setDescription(`**  السيرفر الرسمي للبوت :  :dove:  https://discord.gg/ :scroll: **`)
...
**  ======:blossom:نــتــمــنــآ لــكــم آســتــمـــتــآع :blossom:======  **`)
     ...
     client.on("message", message => {
      if (message.content === "*help-m") {
       const embed = new Discord.RichEmbed() 
           .setColor("#FF00FF")
           .setFooter('By server zYaDxB52#1468  ')
           .setDescription(`**__أتمنى يعجبكم البوت يا أغلى ناس:revolving_hearts: __**`)
     message.author.sendEmbed(embed)
 ...
 .setTitle(`Welcome To ${msg.guild.name}`)
  ...
  .setURL('https://discordapp.com/api/oauth2/authorize?client_id=523199052872155146&permissions=0&scope=bot')
...
var Za7f = [
  ...
  "**اتصل علىابوك و قول له انك رحت مع بنت و الحين هي حامل....**.",
  "**سكر خشمك و قول كلمة من اختيار الاعبين الي معك**.",
...
if (message.author.id !== '283880597095710721') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
j = 1;	
       ...
       i = i+j;	
        client.user.setGame(setGame[i],`https://www.youtube.com/channel/UC7aKwFDX71pasoxXfHPx4kA`);	
}, ms);	
...
message.channel.stopTyping()
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/w4Nuj8J**")
...
/* جميع الحقوق محفوظه ل zYaDxB52#1468 
...
client.on('guildBanAdd', function(guild) {
            const rebellog = client.channels.find("name", "Warnings"),
            Onumber = 3,
  Otime = 10000
